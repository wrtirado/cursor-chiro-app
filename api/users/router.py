...
]  # Example: Allow Office Managers and Billing Admins
...
# TODO: Implement additional user management features
# - User deactivation/activation
# - Password reset functionality
# - User role switching (with proper authorization)
# - Bulk user operations
# - Add/remove patients associated with care providers
# - Manage care provider accounts within an office
