# How to Read DB Tables

## If starting from fresh DB

1. `docker-compose exec api /bin/sh`
2. Copy inspect_db.py script below and paste it in the shell
3. Run `chmod +x /app/inspect_db.py` command
4. Run `python /app/inspect_db.py` command

## If /app/inspect_db.py exists

1. Run `docker-compose exec api /bin/sh`
2. Then run `rm/app/inspect_db.py`
3. Copy inspect_db.py script below and paste it in the shell
4. Run `chmod +x /app/inspect_db.py` command
5. Run `python /app/inspect_db.py` command

## inspect_db.py script

```
cat > /app/inspect_db.py <<EOL
import asyncio
